...
// Helper function for Error UI (Red)
const renderErrorCard = (title, message) => `
        ...
        <div class="alert-wrapper">
            <div class="alert-card">
                <h3>${title}</h3>
                <p>${message}</p>
                <a href="/signup" class="alert-btn">Go Back</a>
            </div>
        </div>
    `;


// Helper function for Success UI (Green with Auto-Redirect)
const renderSuccessCard = (userName) => `
        <meta name="viewport" content="width=device-width, initial-scale=1.0">
        <style>
            .alert-wrapper {
                position: fixed; top: 0; left: 0; width: 100vw; height: 100vh;
        ...
        <div class="alert-wrapper">
            <div class="alert-card">
                ...
                <p>Welcome, <strong>${userName}</strong>! Your account has been registered successfully.</p>
